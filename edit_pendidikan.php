...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM riwayat_pendidikan WHERE id=$id");
...
<body>
<div class="form-card">
    <h2>Edit Riwayat Sekolah</h2>
    <?php if(isset($error)) echo "<p style='color:red;'>$error</p>"; ?>
    <form action="" method="POST">
        <div class="form-group">
            <label>Tingkat Pendidikan</label>
            <input type="text" name="tingkat" value="<?php echo htmlspecialchars($data['tingkat']); ?>" required>
        </div>
        <div class="form-group">
            <label>Nama Instansi / Sekolah</label>
            <input type="text" name="nama_instansi" value="<?php echo htmlspecialchars($data['nama_instansi']); ?>" required>
        </div>
        <div class="form-group">
            <label>Tahun Masuk</label>
            <input type="text" name="tahun_masuk" value="<?php echo htmlspecialchars($data['tahun_masuk']); ?>" required>
        </div>
        <div class="form-group">
            <label>Tahun Lulus</label>
            <input type="text" name="tahun_lulus" value="<?php echo htmlspecialchars($data['tahun_lulus']); ?>" required>
        </div>
        <div class="form-group">
